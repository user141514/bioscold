...
The calibration verdict is that raw HistGB outputs should be interpreted as ranking scores, not calibrated probabilities. The V7 manuscript therefore uses "ranking score" language and avoids absolute score-to-outcome claims.
